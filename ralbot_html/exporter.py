...
from systemrdl.node import AddressableNode, RegNode, RegfileNode, AddrmapNode, MemNode

class ContentBuilder:
    def __init__(self, root, output_dir, **kwargs):
        # Seek to top node
        ...
        self.title = kwargs.pop("title", "%s Reference" % self.top_node.get_property("name"))
    ...
    def run(self):
        ...
        # Traverse tree
        self.visit_addressable_node(self.top_node)
...
#===============================================================================
def export(root, output_dir, **kwargs):
    cb = ContentBuilder(root, output_dir, **kwargs)
    cb.run()
