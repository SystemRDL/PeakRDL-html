...
class HTMLExporter:
    def __init__(self, node, output_dir, options):
        self.top_node = node
        ...
        self.title = options.pop("title", "%s Reference" % self.top_node.get_property("name"))
        self.footer = options.pop("footer", "Generated by RALBot HTML")
